        ...
        <section className="section" id="features">
            ...
            <div className="bento-grid">
                ...
                <div className="bento-item item-1">
                    ...
                    <p>Our AI analyzes your spending patterns to forecast future trends and provide actionable insights.</p>
                </div>
                ...
                <div className="bento-item item-2">
                    ...
                    <div className="bento-icon">
                        <img src="/save-money.png" alt="Smart Saving Icon" style={{ width: '28px', height: '28px', objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
                    </div>
                    <h3>Smart Saving</h3>
                    <p>Maximize your wealth with automated algorithms that find hidden opportunities to save more.</p>
                </div>

                {/* Item 3: 24/7 AI Support */}
                <div className="bento-item item-3">
                    ...
                    <p>Your personal finance assistant is always available to answer questions and execute trades.</p>
                </div>

                {/* Item 4: Institutional Security */}
                <div className="bento-item item-4">
                    ...
                    <p>Bank-grade encryption and multi-factor authentication ensure your assets are always protected.</p>
                </div>
            </div>
        </section>
    );
